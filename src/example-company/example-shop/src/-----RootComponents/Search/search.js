...
import Gallery from 'parentSrc/components/Gallery';
import classify from 'parentSrc/classify';
import Icon from 'parentSrc/components/Icon';
import { getFilterParams } from 'parentSrc/util/getFilterParamsFromUrl';
import getQueryParameterValue from 'parentSrc/util/getQueryParameterValue';
import isObjectEmpty from 'parentSrc/util/isObjectEmpty';
import { X as CloseIcon } from 'react-feather';
import FilterModal from 'parentSrc/components/FilterModal';
import { fullPageLoadingIndicator } from 'parentSrc/components/LoadingIndicator';
import defaultClasses from './search.css';
import PRODUCT_SEARCH from 'parentSrc/queries/productSearch.graphql';
