    ...
    Object.assign(
        {
            ...
            rootDir: `${__dirname}/src/${companyName}`,
        ...
        cb(path.join.bind(path, '<rootDir>', dir))
    );
const jestConfig = {
    projects: [
        configureProject(`${projectName}`, `${displayName}`, inPackage => ({
            ...
            setupFilesAfterEnv: [
                path.join(`${parentRootDir}/scripts/jest-enzyme-setup.js`)
            ],
